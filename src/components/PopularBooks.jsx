...
const PopularBooks = () => {
    ...
    useEffect(() => {
        axios.get("https://virtual-bookshelf-server-cyan.vercel.app/top-books").then(res => {
    ...
    return (
        <div className='max-w-7xl w-11/12 mx-auto p-4 mt-[50px] md:mt-[100px] rounded-[10px] bg-blue-50'>
            ...
            className='text-4xl text-center mb-12 border-t-4 font-semibold border-blue-500 w-fit mx-auto text-black'>Popular Books</motion.p>
